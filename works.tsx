    ...
    <header className={headerClasses}>
      <div className="logo">
        <AppLink href="/index.html">
          <img src="https://res.cloudinary.com/dj3vhocuf/image/upload/v1760896759/Blue_Bold_Office_Idea_Logo_250_x_80_px_7_uatyqd.png" alt="Taj Design Consultancyancy Logo" className="logo-image" />
        </AppLink>
      </div>
  ...
  return (
    <aside className="left-sidebar">
      ...
      <div className="sidebar-footer">
        <p>© Taj Design Consultancyancy 2024. All rights reserved.</p>
      </div>
    </aside>
  );
};
        ...
        <footer id="footer" className="app-footer">
            ...
            <div className="container">
                <div className="copyright-section">
                    <span>2024 © Taj Design Consultancyancy. All rights reserved.</span>
