...
const workItems = [
    { 
      ...
      gallery: [
        ...
        'https://res.cloudinary.com/dj3vhocuf/image/upload/v1761474817/Untitled_design_-_2025-10-26T160137.774_ymqiu8.png',
...
const WorksHero = () => {
    ...
    return (
      <section ref={heroRef} className={`works-hero-section ${isVisible ? 'visible' : ''}`}>
          <div 
              className="hero-background" 
              style={{ backgroundImage: `url('https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1600&auto=format&fit=crop&q=60')` }}
              aria-hidden="true"
          ></div>
          <h1>
              <span className="line"><span>Our Featured</span></span>
              <span className="line"><strong>Projects</strong></span>
          </h1>
      </section>
    );
}
...
const WorksPage = () => {
  ...
  useEffect(() => {
    ...
    const targets = document.querySelectorAll('.project-card-inner');
          ...
          <div className="container">
              ...
              <div className="works-grid">
                  {filteredWorks.map((item, index) => (
                      <div className="project-card-inner" key={item.title} style={{ transitionDelay: `${(index % 3) * 100}ms`}}>
                          <button 
                          ...
                          >
                              ...
                              <div className="project-card-content">
                                  <div>
                                      <p className="project-card-meta">{item.category}</p>
                                      <h3>{item.title}</h3>
                                  </div>
                                  ...
                                  <span className="view-project-link" aria-hidden="true">
