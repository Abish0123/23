...
const CallToAction = () => (
    <section className="cta-section scroll-trigger fade-up">
        <div className="container">
            <h2 className="scroll-trigger fade-up" style={{ transitionDelay: '0.1s' }}>Let's Create Your Space</h2>
            <p className="scroll-trigger fade-up" style={{ transitionDelay: '0.2s' }}>
                Ready to transform your interior? Our team is here to guide you from the first sketch to the final, flawless handover.
            </p>
...
const InfoCard = memo(({ title, icon, items }: { title: string, icon: string, items?: (string | React.ReactNode)[] }) => (
...
const ServicePage = () => {
  ...
  const whatWeDo = [
    'Concept & Space Planning: Test-fits, adjacency planning, mood boards, material palettes.',
    'Detailed Design: GA plans, RCP/MEPF coordination, joinery/shop drawings, door & ironmongery schedules.',
    'FF&E & Finishes: Furniture selection, custom joinery, fabrics, lighting fixtures, samples & mockups.',
    'Authority Compliance (Qatar): Baladiya drawings & submissions, QCDD fire/life-safety documentation, Kahramaa & Ashghal coordination.',
    'Tender & Procurement: BOQs, specs, value engineering, vendor shortlisting, bid analysis.',
    'Fit-Out Execution: Site supervision, quality control, progress reporting, snagging & de-snagging, as-built drawings, O&M manuals.',
    'Handover: Testing & commissioning, completion certificates, move-in support.',
  ];
  ...
  const deliverables = {
    ...
    items: [
        'Concept pack (layouts, mood, 3D visualizations)',
        'Issued-for-Construction drawing set (architectural + coordinated MEP/FLS)',
        'BOQ & specification booklet',
        'Shop drawing review and approvals',
        'Weekly site reports with photos and progress %',
        'Snag list & close-out dossier (as-builts, warranties, manuals)',
    ]
  };
  ...
  const compliance = {
    ...
    items: [
        'Baladiya: building permit/change-of-use, architectural approvals.',
        'QCDD: fire strategy, means-of-egress, material compliance, final inspection.',
        'Kahramaa/Ashghal: as required for utilities and access.',
    ]
  };
  ...
  const projectTypes = {
    ...
    items: [
      ...
      'Retail & F&B outlets',
      'Lobbies & executive floors',
      'Refurbishment projects in high-rise towers'
    ]
  };
  ...
  const whyUs = {
    ...
    icon: "fa-star",
    items: [
        'Fast-track authority coordination (Baladiya & QCDD)',
        'Cost-controlled delivery with transparent BOQs',
        'Photoreal 3D renders to approve before you build',
        'On-site supervision and snag-free handovers',
    ]
  };
  
  const faqs = [
      { question: "How long does a typical office fit-out take?", answer: "For small to medium enterprises (200–800 sqm), a typical fit-out takes approximately 8–14 weeks after initial approvals. Larger floors depend on the project's scope and specific landlord regulations." },
      { question: "Can you work within our existing tower standards?", answer: "Absolutely. Our drawings and specifications are designed to align with both landlord/tower standards and the Qatar Construction Specifications (QCS)." },
      { question: "Do you handle authority approvals?", answer: "Yes, we manage the entire process. We prepare and submit all required Baladiya and QCDD packages and coordinate the necessary inspections through to final approval." },
    ...
    <div className={`app ${loading ? 'loading' : ''}`}>
      ...
      <div className="main-container">
        ...
        <main className="main-content" id="main-content" tabIndex={-1}>
          <section className="service-hero-section scroll-trigger fade-up" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1600&auto=format&fit=crop&q=60')` }}>
            <div className="container">
              <h1 className="scroll-trigger fade-up" style={{transitionDelay: '0.1s'}}>Interior Design & <strong>Fit-Out</strong></h1>
            </div>
          </section>
            ...
            <div className="container">
              <div className="service-content-grid scroll-trigger fade-up" style={{transitionDelay: '0.2s'}}>
                <div className="service-main-content">
                    <h2 className="section-title">Turnkey Interior Solutions</h2>
                    <p>
                        We design and deliver interiors that are elegant, functional, and compliant—managing everything from space planning and materials to contractor coordination and final handover. Our integrated approach ensures a seamless transition from concept to reality, creating spaces that reflect your brand and enhance productivity.
                    </p>
                    <div className="service-list-section">
                        <h2 className="section-title" style={{fontSize: '24px', marginTop: '40px'}}>What we do</h2>
                ...
                <div className="service-sidebar-image">
                  <img src="https://images.unsplash.com/photo-1618220179428-22790b461013?w=800&auto=format&fit=crop&q=60" alt="Modern and elegant office interior designed by Taj Design Consultancy in Qatar." />
                </div>
              </div>
